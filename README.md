...
### !backfill
This command scans previous messages for heart reactions and updates scores. This command first clears the score.json file, iterates through each channel in the server, and records the number of heart reactions on user messages.
